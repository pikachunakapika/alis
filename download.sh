...
curl -O https://raw.githubusercontent.com/pikachunakapika/alis/master/alis-reboot.sh

curl -O https://raw.githubusercontent.com/pikachunakapika/alis/master/alis-recovery.conf
